...
class AboutIteration < Neo::Koan
  ...
  def test_select_selects_certain_items_from_an_array
    ...
    # Map changes the values and creates a new array, but select/findall can be used to query and bring specific elements
  ...
  def test_find_locates_the_first_element_matching_a_criteria
    ...
    assert_equal "Clarence", array.find { |item| item.size > 4 } # Single match
  end
  ...
  def test_inject_will_blow_your_mind
    ...
    # Sum is an accumulator and the inject is returning every iteration
  end
