...
class AboutSymbols < Neo::Koan
  ...
  #
  # That's because when you declare a symbol it's automatically created, so you have to take care to not pollute your code and create false positives
  ...
  #
  # I thinks that's because you pullote your app
end
