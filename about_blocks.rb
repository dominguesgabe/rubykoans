...
class AboutBlocks < Neo::Koan
  ...
  def test_blocks_can_be_assigned_to_variables_and_called_explicitly
    ...
    # Lambda functions in Ruby acts like Anonymous functions in js. They are inline or "do - end" and should be call like below examples
    #  They can or not have args

    assert_equal 11, add_one.call(10)

    # Alternative calling syntax
    assert_equal 11, add_one[10] #strange sum, idk what it would happen in other cases
  end
